...
!(function (a, b) {
  ...
  return (
      ...
      (c.namespaces = {
        ...
        (c.extend = function (a) {
          ...
          for (a = a || {}, b = 1; b < arguments.length; b++) {
            ...
            for (var f in d)
              (e = d[f]),
                'object' != typeof e || null === e || e instanceof Array ? (a[f] = e) : (a[f] = c.extend(a[f], e));
          }
          return a;
        }),
        ...
        (c.getAvailableHeight = function (a, b) {
          return Math.max(
            (c.quantity(b.height).value || a.height()) - (b.chartPadding.top + b.chartPadding.bottom) - b.axisX.offset,
            0
          );
        }),
    ...
    (function (a, b, c) {
      ...
      function e(a) {
        return (
          (this.axisLength * (+c.getMultiValue(a, this.units.pos) - this.range.min)) / (this.range.max - this.range.min)
        );
      }
              ...
              if (
                (m.showPoint &&
                  o.pathElements.forEach(
                    function (b) {
                      var h = i.elem('line', { x1: b.x, y1: b.y, x2: b.x + 0.01, y2: b.y }, a.classNames.point).attr({
          ...
          b.raw.series.forEach(
            function (d, e) {
              ...
              (f =
                ...
                h.addClass(
                  [a.classNames.series, d.className || a.classNames.series + '-' + c.alphaNumerate(e)].join(' ')
                ),
            ...
            function (e, g) {
              if (0 !== j.normalized.series[g] || !a.ignoreEmptyValues) {
                k[g].attr({ 'ct:series-name': e.name }),
                  k[g].addClass(
                    [a.classNames.series, e.className || a.classNames.series + '-' + c.alphaNumerate(g)].join(' ')
                  );
                ...
                if (
                  ...
                  if (B || 0 === B) {
                    var C = b
                      .elem('text', { dx: z.x, dy: z.y, 'text-anchor': d(n, z, a.labelDirection) }, a.classNames.label)
                      .text('' + B);
                    this.eventEmitter.emit('draw', {
                      type: 'label',
                      index: g,
