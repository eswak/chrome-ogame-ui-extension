var fn = function () {
  ...
  window._addSolarSatHelperInterval = function _addSolarSatHelperInterval () {
    setInterval(function () {
      ...
      // ==========================================================================
      var energyProducedPerSat = Math.floor((config.my.planets['[' + _getCurrentPlanetCoordinates().join(':') + ']'].averageTemp + 160) / 6);
      $('li.additional_energy_consumption:not(.enhanced)').each(function() {
        ...
        $(this).append([
          '<span class="enhancement tooltip" style="font-weight:bold;margin-left:5px" title="' + $('.technology.solarSatellite').attr('aria-label') + ': ' + nSats + '">(',
