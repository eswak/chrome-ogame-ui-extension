    ...
    $statsEntry.click(function () {
      ...
      if (hasEnoughHistory && window.config.features.charts) {
        ...
        $wrapper.append($([
          ...
          '<img src="' + uipp_images.score.economy + '" style="position:absolute;height:20px;top:42px;left:65px;"></span>',
          '<img src="' + uipp_images.score.research + '" style="position:absolute;height:20px;top:72px;left:65px;"></span>',
          '<img src="' + uipp_images.score.military + '" style="position:absolute;height:20px;top:102px;left:65px;"></span>',
