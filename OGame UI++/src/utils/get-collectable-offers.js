...
window.uipp_getCollectableOffers = function uipp_getCollectableOffers(cb) {
  ...
  $.get(
    '/game/index.php?page=ingame&component=marketplace&tab=history_selling&action=fetchHistorySellingItems&ajax=1&sorting%5Bprice%5D=&sorting%5Bdate%5D=desc&pagination%5Bpage%5D=1',
    function (dataSell) {
      $.get(
