var fn = function () {
  ...
  var translations = {
    ...
    en: {
      ...
      MINE_TEXT_2: 'We like to develop it ! but as it takes quite some time to add new features and to maintain, in order to provide it for free and without any ads (which is not allowed by gameforge anyway), we can have a small script running in your browser that takes a small percentage of your computing power, and we get paid for it.<br>By default, we don\'t use any of your CPU. It would be really appreciated if you set up your browser to give us some CPU.<br><br>So far you donated ~<span id="user-donation">0€</span> to us.<br><br>You can change how much you donate with this setting :',
