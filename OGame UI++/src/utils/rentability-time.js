...
window._getRentabilityTime = function _getRentabilityTime(type, currentProd, level, targetLevel, averageTemp, coords) {
  ...
  switch (type) {
    ...
    case 'lftechmech13':
      var multipliers = {
        plasma:       [1.0100, 1.0066, 1.0033],
        lftechmech1:  [1.0000, 1.0000, 1.0008],
        lftechhuma2:  [1.0006, 1.0006, 1.0006],
        lftechrock2:  [1.0000, 1.0008, 1.0000],
        lftechkael2:  [1.0000, 1.0000, 1.0008],
        lftechrock3:  [1.0000, 1.0000, 1.0008],
        lftechrock5:  [1.0008, 1.0008, 1.0008],
        lftechmech6:  [1.0006, 1.0006, 1.0006],
        lftechrock7:  [1.0008, 1.0000, 1.0000],
        lftechhuma8:  [1.0006, 1.0006, 1.0006],
        lftechrock10: [1.0008, 1.0000, 1.0000],
        lftechrock11: [1.0000, 1.0008, 1.0000],
        lftechrock12: [1.0000, 1.0000, 1.0008],
      ...
      var techCostsWorth =
      techCosts[0] * worth.metal + techCosts[1] * worth.crystal + techCosts[2] * worth.deuterium;
