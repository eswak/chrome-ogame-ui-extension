    ...
    $('#planetList > div').each(function() {
      ...
      if (shipPoints > threshold || shipsNeedUpdate) {
        ...
        $(this).append([
          ...
          '<img src="' + img + '" class="tooltipHTML" title="' + tooltip + '" style="position: absolute; top: 3px; left: 3px; height: 18px; width: 18px;"/>',
          '</a>'
        ].join(''));
      }
      ...
      if ($(this).find('.moonlink').length) {
        ...
        var shipsNeedUpdateMoon = window.config.my.planets[$(this).find('.planet-koords').text() + 'L'].shipsNeedUpdate <= Date.now();
        ...
        if (shipPointsMoon > threshold || shipsNeedUpdateMoon) {
          ...
          $(this).append([
            ...
            '<img src="' + img + '" class="tooltipHTML" title="' + tooltip + '" style="position: absolute; bottom: 5px; left: 19px; height: 15px; width: 15px;"/>',
            '</a>'
          ].join(''));
        }
      }
